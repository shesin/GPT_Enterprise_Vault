...
const BATCHES = [
  ...
  },
  {
    ...
    files: [
      ...
      'PROJECTS/SmartBeads/src/playtest/web/layout/__tests__/playShellThemes.test.ts',
      'PROJECTS/SmartBeads/src/playtest/web/layout/__tests__/boardLookThemes.test.ts',
      'PROJECTS/SmartBeads/src/playtest/web/layout/__tests__/sidePanelThemes.test.ts',
      ...
      'PROJECTS/SmartBeads/src/playtest/web/layout/__tests__/moveHintAuraThemes.test.ts',
