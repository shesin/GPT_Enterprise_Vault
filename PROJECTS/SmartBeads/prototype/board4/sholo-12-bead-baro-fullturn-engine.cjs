'use strict';
/**
 * Headless 12-bead Baro Guti / 5×5 Alquerque Lab engine.
 * Geometry + start match SHOLO_GUTI_12_BEAD_BARO_WITH_FEATURE.html (classic Alquerque camps).
 * Search/AI identical to sholo-10-bead-fullturn-engine.cjs (honest D1/D2/D3).
 */
