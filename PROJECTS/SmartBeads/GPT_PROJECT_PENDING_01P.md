...
**Purpose:** **Open roadmap, gaps, and risks only** — online multiplayer, timers (HvH), hosting, tournaments, polish backlog.  
**Does not replace:** **`GPT_PROJECT_DECISIONS_05P.md`** (locked game/product choices) · `GPT_PROJECT_STATUS_01P.md` (shipped & verified) · `VISION_05P.md` (broad principles).

**Agents do not edit this file.** Human-owned.
