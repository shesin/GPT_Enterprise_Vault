...
- **AI turn finish (2026-08-20):** optional-stop closes the chain (`completeAiTurnIfChainOpen`); Medium/Hard think budget 800ms with Easy/first-legal fallback so the shell cannot stick on “AI is thinking…”.
