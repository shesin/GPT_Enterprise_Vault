 ...
 * Geometry and starting layout match prototype/board4/SHOLO_GUTI_12_BEAD_6x5_WITH_FEATURE.html
 * and sholo-d4-12-6x5-fullturn-engine.cjs — 30-node Alquerque, empty centre file.
 */
...
/** Reference parity: 30 nodes, 89 undirected edges; centre nodes A22 + A32 (indices 12, 17). */
export const BOARD12X6X5_NODE_COUNT = NODE_SPECS.length;
export const BOARD12X6X5_EDGE_COUNT = buildConnections(ADJACENCY).length;
export const BOARD12X6X5_JUMP_COUNT = buildJumpPaths(NODE_SPECS, ADJACENCY).length;
export const BOARD12X6X5_CENTER_NODE_IDS = buildCenterNodeIds(NODE_SPECS);

export const Board12x6x5: BoardDefinition = {
  name: 'SmartBeads-12x6x5',
  ...
  centerNodeIds: BOARD12X6X5_CENTER_NODE_IDS,
  maxPlies: null,
