'use strict';
/**
 * Headless C4 / 12-bead mini-wing Lab engine.
 * Geometry + start match SHOLO_GUTI_12_BEAD_MINIWING_WITH_FEATURE.html.
...
[
  ['LIT', 'LIM'], ['LIT', 'A20'], ['A20', 'LIM'],
  ['RIT', 'RIM'], ['RIT', 'A24'], ['A24', 'RIM'],
