'use strict';
/**
 * Lab-compare 5-bead (5×3) candidate vs 16-bead standard under the same protocol.
 */
const fs = require('fs');
...
function main() {
  ...
  const report = {
    purpose: 'Compare 5-bead/5×3 candidate vs 16-bead standard — metrics and evidence only (no board verdict)',
