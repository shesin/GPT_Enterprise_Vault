'use strict';
/**
 * Headless C3 / 8-bead 5×5 thinned Lab engine.
 * Geometry + start match SHOLO_GUTI_8_BEAD_5x5_WITH_FEATURE.html (not REJECT 4×5 8-bead).
...
function startingBoard() {
  return [1, 1, 1, 1, 1, 1, 0, 1, 2, 0, 2, 2, 2, 2, 2, 2];
}
